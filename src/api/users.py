...
from src.db.models.user import User, UserCreate, UserPublic, UserUpdate
...
async def create_user(user: UserCreate, session: SessionDep):
    """Create a new user. Raises 422 if email already exists."""
...
async def update_user(id: int, user: UserUpdate, session: SessionDep):
    """Update a user by ID. Raises 404 if not found."""
